...
HFILES=$($CC -mstm8 -Iinc -Isrc -D$CPU "-Wp-MM" -E inc/stm8l10x.h|\
	fmt -1|\
	sed -n 's, *inc/stm8l10x_,stm8l10x_,p')
CFILES=${HFILES//.h/.c}
# remove (the non-existing) stm8l10_conf.c from the list of c files:
CFILES=${CFILES//stm8l10x_conf.c/}
